...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="card-body flex flex-col gap-7 text-lg font-bold">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-1 flex-wrap">
              {technology.map((tech) => (
                <span
                  key={tech}
                  className="text-lg bg-gradient-to-r from-red-800 via-red-700 to-red-600 bg-clip-text text-transparent py-1 bg-slate-100/25 hover:bg-slate-100/10 rounded-2xl"
                >
                  {tech}
                </span>
              ))}
